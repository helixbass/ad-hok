...
Comp = (0, _fp.flow)((0, _.addState)('x', 'setX', 'aaa'), (0, _.addEffect)(function (_ref2) {
  var setX = _ref2.setX;
  return function () {
...
Comp2 = (0, _fp.flow)((0, _.addState)('x', 'setX', 0), (0, _.addEffect)(function (_ref3) {
  var x = _ref3.x,
      setX = _ref3.setX;
  return function () {
    return setX(x + 1);
...
Comp3 = (0, _fp.flow)((0, _.addState)('x', 'setX', 0), (0, _.addEffect)(function (_ref5) {
  var x = _ref5.x,
      setX = _ref5.setX;
  return function () {
    return setX(x + 1);
...
PathDependency = (0, _fp.flow)((0, _.addState)('x', 'setX', 0), (0, _.addEffect)(function (_ref7) {
  var x = _ref7.x,
      setX = _ref7.setX;
  return function () {
    return setX(x + 1);
...
Comp4 = (0, _fp.flow)((0, _.addState)('x', 'setX', 0), (0, _.addEffect)(function (_ref9) {
  var x = _ref9.x,
      setX = _ref9.setX;
  return function () {
    return setX(x + 1);
