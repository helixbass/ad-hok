...
exports.branch = function (test, consequent, alternate) {
    ...
    var ret = function (Component) {
        ...
        var createConsequent = function () {
            var _a;
            var Consequent = flowMax_1.default(consequent, Component);
            Consequent.displayName = "branch(" + (Consequent.displayName == null || Consequent.displayName === 'ret'
                ? (_a = Component.displayName) !== null && _a !== void 0 ? _a : '' : Consequent.displayName) + ")";
            return Consequent;
        };
        var AlternateAsComponent = null;
        var createAlternate = function () {
            var _a;
            var Alternate = flowMax_1.default(alternate, Component);
            Alternate.displayName = "branch(" + (Alternate.displayName == null || Alternate.displayName === 'ret'
                ? (_a = Component.displayName) !== null && _a !== void 0 ? _a : '' : Alternate.displayName) + ")";
            return Alternate;
        };
