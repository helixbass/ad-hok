...
var isSimpleDependenciesArray = function (dependencies) {
    if (!(0, isArray_1.default)(dependencies))
        return false;
...
var createEffectAdder = function (effectHook) { return function (callback, dependencies) {
    ...
    return function (props) {
        ...
        if (!dependencies) {
        ...
        else if ((0, isArray_1.default)(dependencies) && isDependenciesSimpleArray) {
            ...
            if ((0, isArray_1.default)(dependencies)) {
                effectHook(function () {
                    if (prevProps != null &&
                        (0, shallowEqualArray_1.default)(dependencies.map(function (dependencyName) {
                            return (0, get_1.default)(dependencyName, prevProps);
                        }), dependencies.map(function (dependencyName) { return (0, get_1.default)(dependencyName, props); })))
                        return;
