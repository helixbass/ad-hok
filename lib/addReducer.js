...
var addReducer = function (reducer, initialState) { return function (props) {
    var computedInitialState = useMemoized_1.default(function () { return (isFunction_1.default(initialState) ? initialState(props) : initialState); }, []);
    var _a = react_1.useReducer(reducer, computedInitialState), state = _a[0], dispatch = _a[1];
