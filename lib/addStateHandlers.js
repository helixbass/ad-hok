...
var addStateHandlers = function (initial, handlers) { return function (props) {
    var computedInitial = useMemoized_1.default(function () { return (isFunction_1.default(initial) ? initial(props) : initial); }, []);
    ...
    var _a = react_1.useReducer(reducer, computedInitial), state = _a[0], dispatch = _a[1];
    var exposedHandlers = useMemoized_1.default(function () {
        return mapValues_1.default(function (handler, handlerName) { return function () {
            var args = [];
...
exports.default = addStateHandlers;
